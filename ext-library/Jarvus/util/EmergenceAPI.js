 ...
 */
Ext.define('Jarvus.util.EmergenceAPI', {
	...
	,request: function(options) {
		...
		me.fireEvent('beforerequest', options);
		...
		return Ext.Ajax.request({
			...
			,disableCaching: 'disableCaching' in options ? options.disableCaching : me.getDisableCaching()
			,success: function(response) {
				me.fireEvent('requestcomplete', response, options);
			...
			,failure: function(response) {
				me.fireEvent('requestexception', response, options);
				if(response.getResponseHeader('Content-Type') == 'application/json' && options.decodeJson !== false) {
					response.data = Ext.decode(response.responseText, true);
				}
