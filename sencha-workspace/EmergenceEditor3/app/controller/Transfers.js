...
Ext.define('EmergenceEditor3.controller.Transfers', {
...
//        
		EmergenceEditor3.API.on('beforerequest', this.onBeforeRequest, this);
		EmergenceEditor3.API.on('requestcomplete', this.onRequestComplete, this);
		EmergenceEditor3.API.on('requestexception', this.onRequestException, this);

		EmergenceEditor3.API.on('beforefileupload', this.onBeforeFileUpload, this);
	}
	
    ,onBeforeFileUpload: function(path, DOMFile, XHRObject) {
        var newData = Ext.create('EmergenceEditor3.model.Transfer', {
    ...
    ,onAfterFileUpload: function(path, DOMFile, XHRObject) {
        ...
        var store = this.getGrid().getStore()
			...
			,newData = Ext.create('EmergenceEditor3.model.Transfer', {
				requestId: XHRObject.uniqueID
			    ,task: 'Uploaded file'
                ,path: path
