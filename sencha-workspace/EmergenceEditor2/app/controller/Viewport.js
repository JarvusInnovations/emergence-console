...
Ext.define('EmergenceEditor2.controller.Viewport', {
    extend: 'Ext.app.Controller'
    ,requires: [
        'EmergenceEditor2.API'
...
//        debugger
    ...
    ,onSearchClick: function() {
        var query = this.getSearchInput().value,
            ...
            fileType = this.getFileTypeComboBox().getValue(),
            url = searchUrl + encodeURIComponent(query);
        
        if(fileType && fileType != 'All Files') {
			url += '?MIMEType=' + fileType;
        }
...
//        {
//            var navPathHasQueryParams = navPath.indexOf('&'),
//            	query = navPath.substr(navPath.indexOf(':')+1),
