...
Ext.define('EmergenceEditor2.controller.Editor', {
...
//          ,fileclose: 'onFileClose'
        ...
        Ext.Loader.loadScript({
            url: aceRoot + '/ace.js'
            ,onLoad: function() {
                Ext.each(me.aceModules, function(moduleName) {
                    Ext.Loader.loadScript({
                        url: aceRoot + '/' + moduleName + '.js'
                        ,onLoad: function() {
                            app.aceModulesLoaded.push(moduleName);
    ...
    ,onAceEditorActivate: function(editorView) {
        ...
        if(queuedFile) {
            ...
            EmergenceEditor2.API.getFile(queuedFile.path, queuedFile.revisionId, function(response) {
                ...
                queuedFile.revisionId = response.getResponseHeader('x-vfs-id');
